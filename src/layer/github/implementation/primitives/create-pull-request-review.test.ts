...
import type { PullRequestReviewCreationArgs } from './create-pull-request-review.js';

vi.mock('@octokit/core');

describe('createPullRequestReview effect', () => {
  const args: PullRequestReviewCreationArgs = {
    owner: 'cool',
    repo: 'cool',
    pullNumber: 1,
    event: 'COMMENT',
