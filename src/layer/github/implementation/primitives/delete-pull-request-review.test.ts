...
describe('deletePullRequestReview effect', () => {
  ...
  it('should create a comment', async () => {
    ...
    const task = deletePullRequestReview(args);
  ...
  it('should fail with an Octokit request error', async () => {
    ...
    const task = pipe(deletePullRequestReview(args), Effect.flip);
    const result = await Effect.runPromise(task);
  ...
  it('should fail with an api rate limit error', async () => {
    ...
    const task = pipe(deletePullRequestReview(args), ConsoleTestLayer);
